...
public class TriParticleGeometry extends ParticleGeometry<ParticleData> {
    ...
    protected void initBuffers() {
        ...
        // sprite index buffer
        ByteBuffer sib = BufferUtils.createByteBuffer(capacity * prototype.getNumVerts());
        MeshUtils.initializeVertexBuffer(mesh, VertexBuffer.Type.TexCoord3, VertexBuffer.Usage.Stream, VertexBuffer.Format.UnsignedByte, sib, 1);
    ...
    protected void updateMesh() {
        ...
        ByteBuffer spriteIndex = (ByteBuffer)siBuf.getData();
