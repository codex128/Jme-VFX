...
void main() {
    ...
    vec2 scrollUv = fract(vec2(texCoord.x * m_TextureScale + g_Time * m_Speed, texCoord.y));
    vec2 scrollUv2 = fract(vec2(texCoord.x * m_TextureScale + g_Time * m_Speed * 1.1, texCoord.y));
